...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python huggingface_loader.py <ASSET|MULTI> [OUTPUT_DIR]")
        print("Example: python huggingface_loader.py BTC data/raw")
        print("Example: python huggingface_loader.py MULTI data/raw  # Downloads BTC+ETH combined")
    ...
    if asset_arg == "MULTI":
        ...
        download_hf_dataset(asset_arg, output_dir)
